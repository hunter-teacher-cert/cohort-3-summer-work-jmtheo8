...
public class BinSearch
{
  ...
  */
  public static int binSearch ( int[] a, int target )
  {
    ...
    //A: Becase the mid point of the array will determine how to search the srry, one method will search the mid point of array to the left and the other will search the midpoint going from the midpoin to the right until the tarkget value is found.
                                  ...
                                  int loPos, int hiPos )
  {
    ...
    if (hiPos>=loPos)
      int target = loPos + (hiPos-loPos)/2;
    if (int[] a == target)
      return a ;
  ...
  private static boolean isSorted( int[] arr )
  {
    ...
    //A: Becacase this is solved via recursive 
